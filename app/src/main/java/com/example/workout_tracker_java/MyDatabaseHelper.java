...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_TITLE = "ex_title";
    private static final String COLUMN_TOTAL = "total_reps";
    private static final String COLUMN_WEIGHT = "one_rep_max";
    ...
    void addWorkout(String title, String date, int reps, int weight) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();

        cv.put(COLUMN_TITLE, title);
        cv.put(COLUMN_DATE, date);
        cv.put(COLUMN_TOTAL, reps);
    ...
    void updateData(String row_id, String title, String date, int reps, int weight) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_TITLE, title);
        cv.put(COLUMN_DATE, date);
